...
// Використовуючи данні з масиву, за допомоги document.write та циклу
// побудувати структуру по шаблону template2.1 & template2.2. Зробити адекватну
// стилізацію.
...
// //     document.write(`<div> NAME - ${simpson.name} SURNAME - ${simpson.surname} AGE - ${simpson.age}
// //                     </br>INFO - ${simpson.info} </br><img src="${simpson.photo}" alt=""> </div>`);
// // }
// // document.write(`</div>`);
//
// document.write(`<div class="simpson">`);
...
//
// for (let sUser of sUsers) {
//     document.write(`<div class="post-card">
//                         <h3>${sUser.id} - ${sUser.title}</h3>
//                         <p>${sUser.body}</p>
//                     </div>`);
// }
// document.write(`</div>`);
